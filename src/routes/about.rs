...
pub fn About() -> impl IntoView {
    let text_content = [
        ...
        view! {"After completing his studies in Ljubljana, Maj decided to further his musical education by enrolling at the prestigious "<strong>"Jazz Institut Berlin (UdK Berlin - University of Arts Berlin)"</strong>". This move allowed him to expand his musical knowledge and study under renowned professors, including James Robert Rotondi, Nate Wooley, Ralph Alessi, Greg Cohen, and Reggie Moore. His studies in Berlin gave him the opportunity to explore a wide range of musical ideas and develop his skills in both performance and composition."}.into_any(),
        view! {"Throughout his career, Maj has gained extensive experience in a variety of musical settings. He has performed with symphonic and wind orchestras, classical chamber music groups, jazz big bands, and small ensembles. His versatility has allowed him to excel in numerous contexts, from large ensemble performances to intimate solo concerts. As a soloist, Maj has had the honor of performing with the "<strong>"Big Band Radio & Television Slovenia"</strong>" on multiple occasions, showcasing his talent."}.into_any(),
        view! {"In 2019, Maj’s quintet won "<strong>"1st prize at the TEMSIG Musical Competition"</strong>", an event that recognized his musicianship and leadership. His success continued to build when, in 2023, he was invited to perform with the "<strong>"Euroradio Jazz Orchestra"</strong>" in Lithuania and "<strong>"Fame's Institute Orchestra"</strong>" in North Macedonia."}.into_any(),
        view! {"Maj has also been an active participant in various jazz festivals, where he has performed both as a bandleader and a side-man. These festivals have given him the opportunity to collaborate with many esteemed musicians, including "<strong>"Chris Pitsiokos"</strong>", "<strong>"Philipp Gropper"</strong>", "<strong>"Dré Hocevar"</strong>", "<strong>"Bram De Looze"</strong>", "<strong>"Felix Henkelhausen"</strong>", and "<strong>"Jan Bang"</strong>", among others. Through these collaborations, Maj has demonstrated his adaptability and ability to work in diverse musical environments."}.into_any(),
        view! {"In 2024, Maj released his debut album, "<strong>"Galaterna"</strong>", recorded with his quintet and released under the "<strong>"Aut Records"</strong>" label. The album blends the energetic, forward-thinking spirit of modern jazz with elements drawn from old-school American jazz traditions. "<q><strong>"Galaterna"</strong></q>" has been well received by critics, with the album praised for its dynamic and expressive qualities."}.into_any(),
